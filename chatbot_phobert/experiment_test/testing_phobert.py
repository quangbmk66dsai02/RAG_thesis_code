...
def main():
    ...
    file_path = 'experiment_test/independent_10k_test.json'  # Replace with your JSON file path
...
# Accessing the structured data:
    ...
    fine_tuned_model = SentenceTransformer('fine-tuned-phobert-sentence-transformer')
